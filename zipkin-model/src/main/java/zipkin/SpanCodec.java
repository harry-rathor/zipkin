...
import zipkin.internal.ThriftSpanCodec;

/**
 * Includes commodity codec operations needed when working with spans.
 */
public interface SpanCodec {

  /** Implements TBinaryProtocol, a variant supported by all zipkin implementations */
  SpanCodec THRIFT = new ThriftSpanCodec();
